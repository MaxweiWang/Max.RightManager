...
where a.TABLE_NAME='" + table + "' ";
        ...
        public async Task Save(string Type, string Url, string Template, string Str, bool IsCreateAll, string TableName)
        {
            ...
            await Task.Run(() =>
            {
                switch (Type)
                {
                    ...
                    case "Logic":
                        Url = (Url + "\\Logic");
                        Template = Template + "Logic\\Max.Service.txt";
        ...
        {
            //tabs.Register(typeof(Max.Entities.SysClass.Sys_Function));
            //tabs.Register(typeof(Max.Entities.SysClass.Sys_Menu));
            //tabs.Register(typeof(Max.Entities.SysClass.Sys_MenuFunction));
            //tabs.Register(typeof(Max.Entities.SysClass.Sys_Role));
            //tabs.Register(typeof(Max.Entities.SysClass.Sys_RoleMenuFunction));
            //tabs.Register(typeof(Max.Entities.SysClass.Sys_User));
            //tabs.Register(typeof(Max.Entities.SysClass.Sys_UserRole));
